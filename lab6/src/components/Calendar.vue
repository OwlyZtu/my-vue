<template>
    <div class="w-full calendar-container border border-teal-300 rounded-lg shadow-xl">
        <div class="weekdays-grid grid grid-cols-7 bg-green-700 text-white py-3">
        ...
        <div class="days-grid grid grid-cols-7">
            <div v-for="day in calendarDays" :key="day.date"
                :class="['day-item relative p-3 cursor-pointer hover:bg-green-100', 
                         { 'bg-gray-50': day.currentMonth, 'bg-gray-200': !day.currentMonth }]"
